...
"""
CHAD: Ceph Health Auto Diagnostic

See doc/mgr/chad.rst for more info.
"""
...
class CHAD(MgrModule):
    # These are module options we understand.  These can be set with
    #
    #   ceph config set global mgr/chad/<name> <value>
    #
    # e.g.,
    #
    #   ceph config set global mgr/chad/place Earth
    #
    MODULE_OPTIONS = [
        Option(name='basic_check_interval',
               default='300',
               desc='Interval to run basic diagnostic checks.',
    ...
    @CLIReadCommand('chad')
    def chad_status(self, person_name: Optional[str] = None) -> HandleCommandResult:
        """
        Status output of CHAD
        """
    ...
    def serve(self) -> None:
        ...
        while self.run:
            ...
            sleep_interval = self.basic_check_interval
